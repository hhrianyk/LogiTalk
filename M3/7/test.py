...
class MainWindow(CTk):
   ...
   def show_menu(self):
       ...
       if not self.menu_frame.winfo_width() >= 100 and self.is_show_menu:
   ...
   def adaptive_ui(self):
       ...
       self.chat_field.place(x=self.menu_frame.winfo_width(),y=50)
       self.chat_field.configure(width=self.winfo_width() - self.menu_frame.winfo_width() - 20,
                                 height=self.winfo_height() - 40)
       self.send_button.place(x=self.winfo_width() - 150, y=0)
